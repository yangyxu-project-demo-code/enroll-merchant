...
module.exports = React.createClass({
	...
	__createField: function (){
		var _dialog = zr.popup.dialog({
			...
			content: <zr.form.AjaxForm 
				...
				submitApi={{
					method: "post",
					url: '/enroll.merchant/member/createUser'
				}}
	...
	__updateItem: function (data){
		var _dialog = zr.popup.dialog({
			...
			content: <zr.form.AjaxForm 
				...
				submitApi={{
					method: "post",
					url: '/enroll.merchant/member/updateUser',
					data: {
	...
	render:function(){
		return (
			<zr.page.Page title={(this.state.data.Name||'Loading ... ') + " - 会员列表"} className="enroll-merchant-main-member-users" rightRender={this.__pageRightRender}>
