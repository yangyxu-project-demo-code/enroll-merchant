...
module.exports = React.createClass({
	...
	__renderContent: function (){
		...
		return <zr.table.TablePager 
				...
				{ 
					...
					body: function (argv){
						return <div style={{textAlign: 'center', fontSize: 14}}>
							{ !!argv.data.Table_Generated && <a style={{padding: 3}} href={"#/main/event.inivte.data/" + argv.data.zxnz_UUID}><i data-zr-popup-tooltip="查询活动报表" className="fa fa-list-alt zr-padding-3" /></a> }
			...
			data={{
				method: 'post',
				url: '/enroll.merchant/my/inivteEvents',
				data: {
	...
	render:function(){
		return (
			<zr.page.Page title="活动 - 被邀请" className="enroll-user-main-merchant-event-inivte" rightRender={this.__pageRightRender}>
