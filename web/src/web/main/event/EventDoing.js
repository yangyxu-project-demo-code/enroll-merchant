...
module.exports = React.createClass({
	...
	__renderContent: function (){
		...
		return <zr.table.TablePager 
			...
			data={{
				method: 'post',
				url: '/enroll.merchant/my/doingEvents',
				data: {
	...
	render:function(){
		return (
			<zr.page.Page title="活动 - 报名中 ... " className="enroll-user-main-merchant-event-all" rightRender={this.__pageRightRender}>
