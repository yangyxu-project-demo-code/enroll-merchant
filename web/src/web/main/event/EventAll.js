...
module.exports = React.createClass({
		...
		var _dialog = zr.popup.dialog({
			...
			content: <zr.form.AjaxForm 
				...
				onSubmitError={function (xhr){
					zr.popup.notifier.error("修改失败：" + xhr.message);
				}}
				buttons={[
	...
	__renderContent: function (){
		...
		return <zr.table.TablePager 
			...
			data={{
				method: 'post',
				url: '/enroll.merchant/my/allEvents',
				data: {
			...
			onDataCreated={(data)=>this.data = data}
			keyMaps={{
				pageIndex: 'pageIndex',
				pageSize: 'pageSize'
			}}
	...
	render:function(){
		return (
			<zr.page.Page title="所有活动" className="enroll-user-main-merchant-event-all" rightRender={this.__pageRightRender}>
